export const menuItems = [
  ...
  {
    title: "Home",
    icon: "heroicons-outline:home", // Correct icon for Home
    isOpen: true,
    isHide: true,
    link: "crm",
  },
  ...
  {
    title: "Reports",
    icon: "heroicons-outline:document-report", // Updated to document-report
    isOpen: true,
    isHide: true,
    link: "report", 
  },
  ...
  },
  {
    ...
    icon: "heroicons-outline:collection", // Updated to collection
    isOpen: true,
    isHide: true,
    link: "containt-manager",
  },
