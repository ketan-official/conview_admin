...
const CrmPage = lazy(() => import("./pages/comview/dashboard/crm"));
...
// COnview  dashboard
const Report = lazy(() => import("./pages/comview/report"));
// COnview user  dashboard
const Dashoard = lazy(() => import("./pages/user-comview/dashboard"));
...
import Organization from "./pages/comview/organization";
import User from "./pages/comview/user";
import ContaintManager from "./pages/comview/containtManager";
function App() {
  return (
